...
func (_c *UserRoleCreate) SetAssignedBy(v uint) *UserRoleCreate {
	_c.mutation.SetAssignedBy(v)
	return _c
}

// SetNillableAssignedBy sets the "assigned_by" field if the given value is not nil.
func (_c *UserRoleCreate) SetNillableAssignedBy(v *uint) *UserRoleCreate {
	if v != nil {
		_c.SetAssignedBy(*v)
	}
	return _c
...
func (_c *UserRoleCreate) SetAssignerID(id uint) *UserRoleCreate {
...
func (_c *UserRoleCreate) SetNillableAssignerID(id *uint) *UserRoleCreate {
	if id != nil {
...
func (_c *UserRoleCreate) SetAssigner(v *User) *UserRoleCreate {
