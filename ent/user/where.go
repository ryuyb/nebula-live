...
// HasPushSettings applies the HasEdge predicate on the "push_settings" edge.
func HasPushSettings() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasPushSettingsWith applies the HasEdge predicate on the "push_settings" edge with a given conditions (other predicates).
func HasPushSettingsWith(preds ...predicate.UserPushSetting) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := newPushSettingsStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
				p(s)
			}
